...
figlet Tools MR UCOK| lolcat

echo -e  "_____________________________________________________________"
echo -e  "Tools    : MR Ucok$white         " |lolcat
echo -e  "Creadby  : MR Ucok$white   " |lolcat
echo -e  "Team  : Newbie Cyber Team$white " |lolcat
echo -e  "_____________________________________________________________"
...
6) echo "created by : Mr.Ucok NCT" | lolcat
exit
;;
